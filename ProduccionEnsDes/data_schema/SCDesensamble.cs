...
namespace AddonProduccionEnsDes.data_schema
{
    class SCDesensamble
    {
        ...
        public const string TABLE_CABE = "EXC_DESE", TABLE_CABE_DES = "EXC - Desnsamble";
        public const string TABLE_DET1 = "EXC_DES1", TABLE_DET1_DES = "EXC - Det.Desnsamble";
        #endregion
        ...
        public static List<CampoModel> getCamposTablas()
        {
            ...
            myList.Add(new CampoModel() { nombre_tabla = TABLE_DET1, nombre_campo = "EXC_DCHI", descrp_campo = "Desc Chip", tipo_campo = SAPbobsCOM.BoFieldTypes.db_Alpha, tamano = 200 });
            myList.Add(new CampoModel() { nombre_tabla = TABLE_DET1, nombre_campo = "EXC_IMEICH", descrp_campo = "IMEI Chip", tipo_campo = SAPbobsCOM.BoFieldTypes.db_Alpha, tamano = 20 });
            ...
            myList.Add(new CampoModel() { nombre_tabla = TABLE_DET1, nombre_campo = "EXC_PROP", descrp_campo = "Desembalado por", tipo_campo = SAPbobsCOM.BoFieldTypes.db_Alpha, tamano = 50 });
            myList.Add(new CampoModel() { nombre_tabla = TABLE_DET1, nombre_campo = "EXC_ALMI", descrp_campo = "Almacen Ingreso", tipo_campo = SAPbobsCOM.BoFieldTypes.db_Alpha, tamano = 8 });
            myList.Add(new CampoModel() { nombre_tabla = TABLE_DET1, nombre_campo = "EXC_ALMS", descrp_campo = "Almacen Salida", tipo_campo = SAPbobsCOM.BoFieldTypes.db_Alpha, tamano = 8 });
            ...
            myList.Add(new CampoModel() { nombre_tabla = TABLE_DET1, nombre_campo = "EXC_PQDA", descrp_campo = "Paquete de datos", tipo_campo = SAPbobsCOM.BoFieldTypes.db_Alpha, tamano = 20 });
            ...
            myList.Add(new CampoModel() { nombre_tabla = TABLE_DET1, nombre_campo = "EXC_LTEL", descrp_campo = "Linea telefonica", tipo_campo = SAPbobsCOM.BoFieldTypes.db_Alpha, tamano = 30 });
            #endregion
            return myList;
        }
